...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        /*string connectionString = Environment.GetEnvironmentVariable("MySql").ToString();*/
        services.AddDbContext<PeliculasContext>(options => options.UseMySql(connectionString,
